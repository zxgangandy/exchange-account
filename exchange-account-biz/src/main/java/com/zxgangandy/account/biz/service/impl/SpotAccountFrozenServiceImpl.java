...
public class SpotAccountFrozenServiceImpl extends ServiceImpl<SpotAccountFrozenMapper, SpotAccountFrozen> implements ISpotAccountFrozenService {
    ...
    @Override
    public boolean updateOrderFrozen(long uid, long orderId, String bizType, BigDecimal amount) {
        return SqlHelper.retBool(spotAccountFrozenMapper.updateOrderFrozen(uid, orderId, bizType, amount));
    }
}
